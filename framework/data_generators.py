...
def get_target_kaist(anchors, all_img_data, C,batchsize = 8, igthre=0.5,posthre=0.5, negthre=0.3, augment=True):
	current = 0
	...
	while True:
		...
		for img_data in all_img_data[current:current+batchsize]:
			try:
				img_data,x_img, x_img_lwir= data_augment.augment_lwir(img_data, C, augment)
